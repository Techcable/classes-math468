...
It also follows  that every $\bv_\alpha>\bvz$ because applying Lemma (a) to $A\bv_\alpha=\alpha\bv_a$ we get $A\bv_\alpha\ge 0$. Since $\alpha> 0$ then $\bv_\alpha\ge\bvz$ as well.
\vspace{5mm} \\
